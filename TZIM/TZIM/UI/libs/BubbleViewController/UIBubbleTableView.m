...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        return MAX([UIBubbleTypingTableViewCell height], self.showAvatars ? 60 : 0);
    }
    ...
    return MAX(data.insets.top + data.view.frame.size.height + data.insets.bottom, self.showAvatars ? 60 : 0);
}

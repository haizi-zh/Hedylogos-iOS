...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text = [NSString stringWithFormat:@"未读数量:%ld %@ 用户 ID:%ld Time: %ld", (long)conversation.unReadMessageCount, conversation.chatterName, (long)conversation.chatterId, (long)conversation.lastUpdateTime];
